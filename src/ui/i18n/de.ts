...
export const de: Record<MsgKey, string> = {
  ...
  'controls.startTrackTitle': 'Startposition der Lok — die Gleiswahl setzt die Anlage zurück und stellt die Lok so auf das Gleis, dass seine Reedkontakte möglichst vor ihr liegen, Blickrichtung IU',
  ...
  'controls.seatMismatch': 'Die Lok steht nicht auf der Startposition der geöffneten Aufgabenstellung — ein Live-Lauf von hier kann von den bewerteten Checks abweichen. Netzwerk erneut öffnen, um die Lok dorthin zu setzen.',
